...
export interface ApiEditionEdition extends Schema.CollectionType {
  ...
  attributes: {
    isbn10: Attribute.String & Attribute.Unique;
    isbn13: Attribute.String & Attribute.Unique;
    ...
    languageId: Attribute.Integer;
    format: Attribute.String;
    external: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
